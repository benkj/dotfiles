...
return {
    {
        ...
        keys = {
            { ',gf', '<cmd>DiffviewFileHistory<cr>', desc = 'File history' },
            { ',gd', '<cmd>DiffviewOpen<cr>', desc = 'Diff view' },
            { ',gq', '<cmd>DiffviewClose<cr>', desc = 'Diff view close' },
        },
        opts = function()
            ...
            return {
                ...
                keymaps = {
                    ...
                    view = {
                        ...
                        { 'n', ',Go', actions.conflict_choose('ours'),       { desc = 'Choose the OURS version of a conflict' } },
                        { 'n', ',Gt', actions.conflict_choose('theirs'),     { desc = 'Choose the THEIRS version of a conflict' } },
                        ...
                        { 'n', ',Gd', actions.conflict_choose('none'),       { desc = 'Delete the conflict region' } },
                        { 'n', ',GO', actions.conflict_choose_all('ours'),   { desc = 'Choose the OURS version of a conflict for the whole file' } },
                        { 'n', ',GT', actions.conflict_choose_all('theirs'), { desc = 'Choose the THEIRS version of a conflict for the whole file' } },
                    ...
                    file_panel = {
                        ...
                        { 'n', ',GD', actions.conflict_choose_all('none'),   { desc = 'Delete the conflict region for the whole file' } },
                    },
                    file_history_panel = {
